	...
	Panzoom.prototype = {
		...
		setMatrix: function(matrix, options) {
			...
			if (contain) {
				...
				// fix  对 变化量  作补偿 
				var scaleDiffH = (height - this.elem.offsetHeight) / 2;
				var spaceHTop =  scaleDiffH + dims.border.top;
				var spaceHBottom = (height - conHeight) - scaleDiffH  - dims.border.top - dims.border.bottom;
				...
				// console.log('matrix,scaleDiffH,matrix[5], spaceHTop,spaceHBottom,height,conHeight',matrix,scaleDiffH,matrix[5], spaceHTop,spaceHBottom,height,conHeight)
			}
